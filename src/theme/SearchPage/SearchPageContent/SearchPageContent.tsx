...
import {ResultDispatcher, ResultDispatcherState} from "@site/src/theme/SearchPage/types/types";
...
export const SearchPageContent = (): ReactNode => {
    ...
    const  handleArticleClick = ( e: React.MouseEvent<HTMLElement>, url: string): void => {
    ...
    const noResults = !searchResultState.items.length && !searchResultState.loading && searchQuery
    return (
        <Layout>
            <Head>
                ...
                <div className={clsx('row', styles.searchResultContainer)}>
                    <div className={clsx('col', 'col--8', styles.searchResultsColumn)}>
                        ...
                        {!!noResults && (
                            ...
                            <div className={styles.noResultsContainer}><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <mask id="mask0_711_5166" style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x="2" y="2" width="16" height="16">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M9.16667 2.5C5.48477 2.5 2.5 5.48477 2.5 9.16667C2.5 12.8486 5.48477 15.8333 9.16667 15.8333C10.7073 15.8333 12.1258 15.3108 13.2547 14.4332L15.6607 16.8393C15.9862 17.1647 16.5138 17.1647 16.8393 16.8393C17.1647 16.5138 17.1647 15.9862 16.8393 15.6607L14.4332 13.2547C15.3108 12.1258 15.8333 10.7073 15.8333 9.16667C15.8333 5.48477 12.8486 2.5 9.16667 2.5ZM4.16667 9.16667C4.16667 6.40524 6.40524 4.16667 9.16667 4.16667C11.9281 4.16667 14.1667 6.40524 14.1667 9.16667C14.1667 11.9281 11.9281 14.1667 9.16667 14.1667C6.40524 14.1667 4.16667 11.9281 4.16667 9.16667Z" fill="#19191A"/>
                                </mask>
                                <g mask="url(#mask0_711_5166)">
                                    <rect width="20" height="20" fill="#E7596A"/>
                                </g>
                                <mask id="mask1_711_5166" style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x="6" y="6" width="6" height="6">
                                    <path d="M7.49709 7.14418C7.39946 7.04655 7.24117 7.04655 7.14354 7.14418C7.0459 7.24181 7.0459 7.4001 7.14354 7.49773L8.64614 9.00033L7.14354 10.5029C7.04591 10.6006 7.04591 10.7589 7.14354 10.8565C7.24117 10.9541 7.39946 10.9541 7.49709 10.8565L8.99969 9.35389L10.5023 10.8565C10.5999 10.9541 10.7582 10.9541 10.8558 10.8565C10.9535 10.7589 10.9535 10.6006 10.8558 10.5029L9.35324 9.00033L10.8558 7.49773C10.9535 7.4001 10.9535 7.24181 10.8558 7.14418C10.7582 7.04655 10.5999 7.04655 10.5023 7.14418L8.99969 8.64678L7.49709 7.14418Z" fill="black" stroke="black" stroke-linecap="round" stroke-linejoin="round"/>
                                </mask>
